...
export const metadata: Metadata = {
  title: "Privacy Policy | Slow Tunisia",
  description: "Privacy Policy for Slow Tunisia travel services.",
};
        ...
        <div className="prose prose-lg max-w-none space-y-8">
          <section>
            ...
            <p className="text-white/50 leading-relaxed">
              Slow Tunisia ("we," "our," or "us") is committed to protecting your privacy. 
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-white/50 space-y-2">
              <li>Plan and customize your Tunisia journey</li>
          ...
          <section>
            ...
            <p className="text-white/50 leading-relaxed">
              ...
              hotels, guides, and transport providers in Tunisia. We do not sell your 
          ...
          <section>
            ...
            <p className="text-white/50 leading-relaxed">
              ...
              these rights, please contact us at hello@slowtunisia.com.
            </p>
          </section>
