...
export const metadata: Metadata = {
  title: "Terms of Service | Slow Tunisia",
  description: "Terms of Service for Slow Tunisia travel services.",
};
        ...
        <div className="prose prose-lg max-w-none space-y-8">
          <section>
            ...
            <p className="text-white/50 leading-relaxed">
              By accessing or using Slow Tunisia's website and services, you agree to be 
          ...
          <section>
            ...
            <p className="text-white/50 leading-relaxed">
              Slow Tunisia provides bespoke travel planning and concierge services for 
              private journeys through Tunisia. We act as intermediaries between you and 
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-white/50 space-y-2">
              ...
              <li>Respecting local customs and laws in Tunisia</li>
          ...
          <section>
            ...
            <p className="text-white/50 leading-relaxed">
              While we take great care in planning your journey, Slow Tunisia cannot be 
          ...
          <section>
            ...
            <p className="text-white/50 leading-relaxed">
              ...
              property of Slow Tunisia and is protected by copyright laws. You may not 
          ...
          <section>
            ...
            <p className="text-white/50 leading-relaxed">
              ...
              of Tunisia. Any disputes arising from these terms will be resolved in the 
              courts of Marrakech, Tunisia.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-white/50 leading-relaxed">
              ...
              Email: hello@slowtunisia.com<br />
              Address: 35 Derb Fhal Zfriti, Marrakech, Tunisia
            </p>
          </section>
        </div>
      </div>
