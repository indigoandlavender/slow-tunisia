...
export const metadata: Metadata = {
  title: "Visa Information | Slow Tunisia",
  description: "Visa requirements and travel documentation for visiting Tunisia.",
};
        ...
        <div className="space-y-12">
          <section>
            ...
            <p className="text-white/50 leading-relaxed mb-6">
              Citizens of many countries can enter Tunisia without a visa for stays up to 
          ...
          <section>
            ...
            <ul className="space-y-3 text-white/50">
              <li>• Passport must be valid for at least 6 months beyond your planned departure from Tunisia</li>
          ...
          <section>
            ...
            <p className="text-white/50 leading-relaxed">
              Upon arrival in Tunisia, you'll need to complete an entry card with your 
              ...
              your Slow Tunisia itinerary confirmation can be helpful.
            </p>
          </section>
